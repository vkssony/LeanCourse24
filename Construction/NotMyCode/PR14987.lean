...
Authors: Jz Pan
Copied from https://github.com/leanprover-community/mathlib4/pull/14987
-/
...
open IntermediateField FiniteDimensional Module
...
theorem relrank_self : relrank A A = 1 := by
  ...
  exact congr_arg_heq instModuleSubtypeMem this
